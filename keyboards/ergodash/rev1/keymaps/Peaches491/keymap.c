...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_ADJUST] = LAYOUT(
    _______, RGB_M_P, RGB_M_B, RGB_M_R,RGB_M_SW, RGB_M_K,RGB_M_T,                       _______, _______, _______, _______, _______, _______, _______, \
...
// Use the middle 8 LEDs to indicate state
const rgblight_segment_t PROGMEM dm_rgb_raise_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {8, 8, HSV_ORANGE}
);
const rgblight_segment_t PROGMEM dm_rgb_lower_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {8, 8, HSV_CYAN}
);
const rgblight_segment_t PROGMEM dm_rgb_both_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {8, 8, HSV_PURPLE}
);
